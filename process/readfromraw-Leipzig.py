...
def main():
    ...
    '''It's safe to use readlines(), as we have a sentence for each line '''
    file_content = open(args.filename, encoding='utf-8').readlines()
    ...
    metadata.write(">")
    metadata.close()
    '''Clean up nasty characters / currently no cleaning for Leipzig'''
